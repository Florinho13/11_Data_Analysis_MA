...
write.xlsx(scored_soil_data_rq_total,"./02_output/08_SHI/shi_total_rq.xlsx")
...
shi_mean_rq_total <- scored_soil_data_rq_total %>% 
  ...
  summarise(across(
    .cols = c("pH", "microbial_c", "Mg_aus_kation_mmol_kg", 
              "Na_aus_kation_mmol_kg", "C%_normal", "C/N_normal", 
...
write.xlsx(shi_mean_rq_total,"./02_output/08_SHI/shi_mean_total_rq.xlsx")
...
shi_mean_rq_total_prep <- shi_mean_rq_total %>%
  ...
  pivot_longer(cols = 4:12, names_to = "variable", values_to = "SHI score")
